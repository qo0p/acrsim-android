...
Случай когда нет возможности открытия ZReport, все блоки заняты. Нужно отправить все Receipt.
...
| `Z1 ` | `Z2 ` | `Z3 ` | `Z4 ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` |
|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|

При открытии ZReport заимствуется блок памяти из Receipt для нового ZReport

`ZREPORTS_ALLOCATED` = 5<br>
`RECEIPTS_ALLOCATED` = 9<br>
`ZREPORTS_COUNT` = 5<br>
`RECEIPTS_COUNT` = 0<br>

| `Z1 ` | `Z2 ` | `Z3 ` | `Z4 ` | `Z5 ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` | `R. ` |
|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|

Случай когда нет возможности открытия ZReport

`ZREPORTS_ALLOCATED` = 13<br>
`RECEIPTS_ALLOCATED` = 1<br>
`ZREPORTS_COUNT` = 13<br>
`RECEIPTS_COUNT` = 0<br>

| `Z1 ` | `Z2 ` | `Z3 ` | `Z4 ` | `Z5 ` | `Z6 ` | `Z7 ` | `Z8 ` | `Z9 ` | `Z10` | `Z11` | `Z12` | `Z13` | `R. ` |
|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|-------|


## Инструкции

Перед вызовом инструкций апплета, смарт-карта должна быть подключена к считывателю, и вызвана APDU-команда выбора апплета `66697363616c6472697665533031`

```
<< 00 A4 04 00 0E 66697363616C6472697665533031
>> 9000
```

После вызова инструкций апплета, должна быть вызвана APDU-команда отмены выбора апплета

```
<< 00 A4 04 00 00
>> XXXXXXXXXXXXXXXXXXXXXXXXXXXX 9000
```

> см. класс [uz.yt.ofd.android.lib.applet.command.Applet](app/src/main/java/uz/yt/ofd/android/lib/applet/command/Applet.java)
...
Поле `Type` / `TAG_TYPE` — тип чека (`ReceiptType`). Допустимые значения:

| Константа   | Значение | Описание                                      |
|-------------|:--------:|-----------------------------------------------|
| `Purchase`  |  `0x00`  | Обычный чек (покупка / реализация)            |
| `Advance`   |  `0x01`  | Аванс (предоплата)                            |
| `Credit`    |  `0x02`  | Кредит (отсрочка платежа / продажа в кредит)  |
...
Поле `Operation` / `TAG_OPERATION` — тип операции (`OperationType`). Допустимые значения:

| Константа | Значение | Описание                                                          |
|-----------|:--------:|-------------------------------------------------------------------|
| `Sale`    |  `0x00`  | Продажа                                                           |
| `Refund`  |  `0x01`  | Возврат (отзыв); для этого типа заполняется `RefundInfo`         |
...
| `TAG_TYPE`           | `a3.05` | `byte`        | Тип чека (`0x00` Purchase, `0x01` Advance, `0x02` Credit; см. [Тип чека](#тип-чека)) |
| `TAG_OPERATION`      | `a3.06` | `byte`        | Тип операции (`0x00` Sale, `0x01` Refund; см. [Тип операции](#тип-операции)) |
...
| `TAG_TYPE`             | `a5.05` | `byte`       | Тип чека (`0x00` Purchase, `0x01` Advance, `0x02` Credit; см. [Тип чека](#тип-чека)) | 
...
| `TAG_TYPE`                  | `8d.04` | `BCD` (от 1 до 8 байтов) | Тип чека (BCD: `0x00` Purchase — обычный, `0x10` Advance — аванс, `0x20` Credit — кредит; логические значения см. [Тип чека](#тип-чека)) |
| `TAG_OPERATION`             | `8d.05` | `BCD` (от 1 до 8 байтов) | Тип операции (BCD: `0x00` Sale — продажа, `0x10` Refund — возврат; логические значения см. [Тип операции](#тип-операции)) |
...
| `TAG_PPTID`                | `0x08` | `ASCII-цифры` (не более 32 байтов)     | Идентификатор транзакции платежа процессингово центра                                |
| `TAG_CARD_TYPE`            | `0x09` | `byte`                                 | Тип пластиковой карты (`0x01` - корпоративная, `0x02` - личная, `0x03` - социальная) |
| `TAG_CARD_NUMBER`          | `0x0b` | `ASCII-цифры и *`                      | Номер социальной карты (8600********1234)                                            |
...
| `TYPE`           | `0x40:0x01` | `byte`          | Тип чека (`0x00` Purchase, `0x01` Advance, `0x02` Credit; см. [Тип чека](#тип-чека)) |
| `OPERATION`      | `0x41:0x01` | `byte`          | Тип операции (`0x00` Sale, `0x01` Refund; см. [Тип операции](#тип-операции)) |
