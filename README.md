...
| `GET_INFO`                            | `0x00`  | `0x00` | `0x01` | `0x00` |                  | `Info` + `SW`              | Получить информацию об ФМ                                                                                                                                                             |
| `GET_FISCAL_MEMORY_INFO`              | `0x00`  | `0x00` | `0x02` | `0x00` |                  | `FiscalMemoryInfo` + `SW`  | Получить информацию фискальной памяти ФМ                                                                                                                                              |
| `GET_UNACKNOWLEDGED_ZREPORTS_INDEXES` | `0x00`  | `0x00` | `0x03` | `0x00` |                  | `short` + `[]short` + `SW` | Получить индексы неотправленных на сервер ZReport                                                                                                                                     |
| `GET_ZREPORT_INFO`                    | `0x00`  | `0x01` | `0x00` | `0x00` | `список тегов`   | `ZReportInfo` + `SW`       | Получить информацию о ZReport, в DATA можно передавать список тегов полей (`[]byte`)                                                                                                  |
| `GET_ZREPORT_FILE`                    | `0x00`  | `0x02` | `0x00` | `0x00` |                  | `ZReportFile` + `SW`       | Получить файл ZReport для отправки на сервер                                                                                                                                          |
...
| `GET_RECEIPT_INFO`                    | `0x00`  | `0x05` | `0x00` | `0x00` | `список тегов`   | `ReceiptInfo` + `SW`       | Получить информацию о Receipt, в DATA можно передавать список тегов полей (`[]byte`)                                                                                                  |
| `GET_RECEIPT_FILE`                    | `0x00`  | `0x06` | `0x00` | `0x00` |                  | `ReceiptFile` + `SW`       | Получить файл Receipt для отправки на сервер                                                                                                                                          |
| `ACK`                                 | `0x00`  | `0x09` | `0xXX` | `0xYY` | `AckFile`        | `SW`                       | Передать в ФМ `AckFile` (для быстрого выполнения нужно в P1,P2 передать индекс ZReport/Receipt в памяти ФМ) от сервера полученный в ответ на передачу `ZReportFile` или `ReceiptFile` |
