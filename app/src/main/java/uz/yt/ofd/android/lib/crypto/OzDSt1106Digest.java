package uz.yt.ofd.android.lib.crypto;

/**
 * Хеширователь УзДСТ 1106
 *
...
public class OzDSt1106Digest {
    ...
    public OzDSt1106Digest() {
        sBox = cipher.getSBox("D-A");
        cipher.init(true, sBox, null);

        reset();
    }

    public OzDSt1106Digest(String sBoxName) {
        sBox = cipher.getSBox(sBoxName);
        cipher.init(true, sBox, null);
    ...
    private void longToLittleEndian(long n, byte[] bs, int off) {
